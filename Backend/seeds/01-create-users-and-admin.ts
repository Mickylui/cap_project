...
export async function seed(knex: Knex): Promise<void> {
    ...
    await knex("users").insert([
        ...
        {account_name: "jack",email:"jack@1.com",password:hashedPassword,is_admin:false,default_contact:"jack@1.com",icon:"jack.img",slogan:"I am jack"},
        {account_name: "mary",email:"mary@1.com",password:hashedPassword,is_admin:false,default_contact:"jack@1.com",icon:"mary.img",slogan:"Yay"},
        {account_name: "teddy",email:"teddy@1.com",password:hashedPassword,is_admin:false,default_contact:"jack@1.com", icon:"teddy.img",slogan:"Yay"},
        {account_name: "dorri",email:"dorri@1.com",password:hashedPassword,is_admin:false,default_contact:"dorri@1.com"},
        {account_name: "happy",email:"happy@1.com",password:hashedPassword,is_admin:false,default_contact:"happy@1.com"}
    ])
    .returning("id");
    ...
    await knex("user_info").insert([
        ...
        {first_name:"mary",last_name:"Yu",area:"New Territories",district:"Yuen Long",location:"Mansion A",contact:"12345678",gender:"F",age_range:"15-20",reason:"because of friends",learning_level:"Intermediate",user_id:result[4].id},
