...
export async function seed(knex: Knex): Promise<void> {
    ...
    await knex("users").insert([
        ...
        {account_name: "jack",email:"jack@1.com",password:hashedPassword,is_admin:false,default_contact:"jack@1.com"},
        {account_name: "mary",email:"mary@1.com",password:hashedPassword,is_admin:false,default_contact:"jack@1.com"},
        {account_name: "teddy",email:"teddy@1.com",password:hashedPassword,is_admin:false,default_contact:"jack@1.com"}   
    ])
    .returning("id");
